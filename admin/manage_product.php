		...
		<div class="row">
			<div class="col-10 offset-1 bg-white p-4 rounded shadow-lg">
				...
				<form method="post" enctype="multipart/form-data">
					...
					<div class="mb-3">
						<label for="sub_categories_id" class="form-label">Sub Categories</label>
					...
					<div class="mb-3">
						<label from="best_seller" class="form-label">Best Seller</label>
						<select class="form-select" name="best_seller" id="best_seller" required>
						...
						foreach($attrProduct as $list){?>
							<div class="row"id="attr_<?php echo $attrProductLoop?>">
								...
								<div class="col-lg-2">
									...
									<?php if($attrProductLoop==1){ ?>
										<button id="" type="button" class="btn btn-lg btn-info" onclick="add_more_attr()">
											Add More
										</button>
									<?php }else{ ?>
										<button id="" type="button" class="btn btn-lg btn-danger" onclick="remove_attr('<?php echo $attrProductLoop?>','<?php echo $list['id']?>')">
											Remove
										</button>
									<?php } ?>
						...
						<div class="row"  id="image_box">
							...
							if(isset($multipleImageArr[0])) {
								foreach($multipleImageArr as $list) {
									...
									echo "<a target='_blank' href='".PRODUCT_MULTIPLE_IMAGE_SERVER_PATH.$list['product_images']."'><img width='150px' src='".PRODUCT_MULTIPLE_IMAGE_SERVER_PATH.$list['product_images']."'/></a>";
					...
					<div class="mb-3">
						...
						<textarea name="short_desc" id="short_desc" placeholder="Enter product short description" class="form-control" required>
							<?php echo $short_desc; ?>
						</textarea>
					</div>
					<div class="mb-3">
						<label for="description" class="form-label">Description</label>
						<textarea name="description" id="description" placeholder="Enter product description" class="form-control" required>
							<?php echo $description; ?>
						</textarea>
					</div>
					<div class="mb-3">
						<label for="meta_title" class="form-label">Meta Title</label>
						<textarea name="meta_title" id="meta_title" placeholder="Enter product meta title" class="form-control">
							<?php echo $meta_title; ?>
						</textarea>
					</div>
					<div class="mb-3">
						<label for="meta_desc" class="form-label">Meta Description</label>
						<textarea name="meta_desc" id="meta_desc" placeholder="Enter product meta description" class="form-control">
							<?php echo $meta_desc; ?>
						</textarea>
					</div>
					<div class="mb-3">
						<label for="meta_keyword" class="form-label">Meta Keyword</label>
						<textarea name="meta_keyword" id="meta_keyword" placeholder="Enter product meta keyword" class="form-control">
