  <!-- start go top button -->
  <button id="topButton" class="btn btn-success shadow-lg">
      <i class="fa fa-arrow-up" aria-hidden="true"></i>
  </button>
  <!-- end go top button -->
   
   <!-- start footer section -->
   <footer class="text-center text-lg-start bg-success text-muted p-3 mt-5">
      <section class="">
          ...
          <div class="row mt-3">
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              ...
              <p class="text-white">
                ...
                praesentium eveniet est ab odit id dignissimos veniam corrupti
                atque vero rerum provident nobis, ratione doloremque.
              </p>
            </div>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <p class="text-white">
                <i class="fas fa-home me-3"></i> 10/5 abc road, abc
              </p>
              <p class="text-white">
              ...
              <p class="text-white">
                <i class="fas fa-phone me-3"></i> 9999999999
              </p>
              <p class="text-white">
                <i class="fas fa-print me-3"></i> 9999999999
              </p>
            </div>
          </div>
        </div>
