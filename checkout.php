		...
		<div class="row">
			<div class="col-md-8">
				<?php echo $errMsg?>
											...
											<div class="col-md-6">
												<div class="">
													<form id="login-form" method="post">
														...
														<div class="mb-3">
															<input type="email" name="login_email" id="login_email" placeholder="Enter your email" class="form-control" />
											...
											<div class="col-md-6">
												<div class="">
													<form action="#">
														...
														<button type="button" class="btn btn-lg btn-success" onclick="user_register()">Register</button>
													</form>
												</div>
											</div>
										</div>
                    ...
                    <div class="col-md-4">
                        <div class="">
                            <h5 class="text-center mb-4">Your Order</h5>
                            <div class="">
                                <?php
								$cart_total=0;
								foreach($_SESSION['cart'] as $key=>$val){								
